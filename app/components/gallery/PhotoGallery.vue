<template>
  <div class="photo-gallery-wrapper">
    <!-- Layout Switcher -->
    <div v-if="!loading && photos.length > 0" class="layout-switcher flex justify-end items-center gap-2 mb-4">
    ...
    <!-- Photo Gallery with Layout Component -->
